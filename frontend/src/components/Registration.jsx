  ...
  return (
    <div className="register-navbar">
      ...
      {[
        ...
        <i key={index} className={`fa-solid ${icon} icon icon${index + 1}`}></i>
      ))}
    </div>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="registration-form-group">
              ...
              <div className="registration__box-input">
                ...
                />
                <label htmlFor="userName" className="registration__label">
                  Name
                </label>
              </div>
            </div>
            ...
            <div className="registration-form-group">
              ...
              <div className="registration__box-input">
                <input
                  ...
                  className="registration__input"
                />
                <label htmlFor="department" className="registration__label">
                  Department
                </label>
              </div>
            </div>
            ...
            <div className="registration-form-group">
              ...
              <div className="registration__box-input">
                <input
                  ...
                  className="registration__input"
                />
                <label htmlFor="collegeName" className="registration__label">
                  College Name
                </label>
              </div>
            </div>
