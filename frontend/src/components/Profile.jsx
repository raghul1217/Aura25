        ...
        <div id="rotating-animation">
          <div>
            {[
              ...
              <i
                key={index}
                className={`fa-solid ${icon} icon icon${index + 1}`}
              ></i>
            ))}
          </div>
        </div>
          ...
          <div className="profile-card">
            ...
            <div className="profile-info-container">
              <div className="profile-bio-div">
                <h1 className="profile-bio">Bio</h1>
              </div>
              ...
              <div className="profile-bio-div">
                <h1 className="payment-payhead profile-bio ">Payment</h1>
              </div>
              ...
              {!data.paymentStatus && (
                <div className="payment-proceed">
                  <Link to="/payment">
                    <button className="custom-btn-pay btn-11">
                      Proceed to pay
                    </button>
                  </Link>
                </div>
              ...
              <div className="profile-info">
                ...
                <div className="info-data payment-status">
                  ...
                  <span>
                    {data.paymentStatus ? "Verified" : "Not Verified"}
                  </span>
                  {data.paymentStatus ? (
                    <FaCheckCircle
